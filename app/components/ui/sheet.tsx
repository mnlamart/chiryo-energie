  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          "fixed z-50 gap-4 shadow-lg transition-all ease-in-out duration-300 data-[state=open]:opacity-100 data-[state=closed]:opacity-0",
          sideClasses[side],
          className
        )}
        {...props}
      >
        {children}
        <DialogPrimitive.Close className="absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-secondary p-2 md:p-1">
