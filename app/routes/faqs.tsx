...
export default function FAQsPage() {
  ...
  return (
    <>
      ...
      <meta name="description" content="Trouvez les réponses aux questions fréquentes sur les services de bien-être holistique de Chiryo Energie à Joué-Les-Tours : Reiki, Sophro-relaxation, Réflexologie, Magnétisme, Médiumnité." />
